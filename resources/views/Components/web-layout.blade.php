            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ url('webHome') }}" class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="w-10 h-10 rounded-full bg-cover bg-center" style="background-image: url('{{ Auth::user()->avatar ?? 'https://via.placeholder.com/150' }}')"></button>
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
    ...
    <footer class="bg-[#202025] text-white pt-14 pb-8">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="md:col-span-2 flex flex-col justify-between">
                ...
                <a href="https://www.facebook.com" aria-label="Facebook" class="w-10 h-10 rounded-full bg-[#36363a] flex items-center justify-center hover:bg-[#b0b0cf] transition-colors" title="Facebook">
                    <i class="fab fa-facebook-f"></i>
                </a>
                <a href="https://www.linkedin.com" aria-label="LinkedIn" class="w-10 h-10 rounded-full bg-[#36363a] flex items-center justify-center hover:bg-[#b0b0cf] transition-colors" title="LinkedIn">
                    <i class="fab fa-linkedin-in"></i>
                </a>
                <a href="https://www.instagram.com" aria-label="Instagram" class="w-10 h-10 rounded-full bg-[#36363a] flex items-center justify-center hover:bg-[#b0b0cf] transition-colors" title="Instagram">
            ...
            <div>
                ...
                <ul class="space-y-3">
                <li><a href="{{ url('/webHome') }}" class="text-gray-400 hover:text-white transition-colors">Home</a></li>
                <li><a href="{{ url('/webCourses') }}" class="text-gray-400 hover:text-white transition-colors">Courses</a></li>
                <li><a href="{{ url('/webProfs') }}" class="text-gray-400 hover:text-white transition-colors">Teachers</a></li>
