    ...
    <div class="bg-gradient-to-br from-[#b0b0cf] to-[#8a8aac] pt-16 pb-24">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center gap-8">
                <div class="relative">
                    <div class="w-32 h-32 rounded-full bg-cover bg-center border-4 border-white" style="background-image: url('{{ Auth::user()->avatar ?? 'https://via.placeholder.com/150' }}')"></div>
                ...
                <div class="text-center md:text-left">
                    <div class="flex items-center justify-center md:justify-start gap-3">
                        <h1 class="text-3xl font-bold text-white">{{ Auth::user()->name ?? 'Guest User' }}</h1>
                        <span class="px-3 py-1 bg-white bg-opacity-20 text-white text-xs font-bold rounded-full">Student</span>
                    </div>
                    <p class="text-white text-opacity-80 mt-2">{{ Auth::user()->email ?? 'guest@example.com' }}</p>
                </div>
                <div class="ml-auto flex gap-2">
                    <button class="px-5 py-2.5 bg-white bg-opacity-20 text-white font-semibold rounded-lg hover:bg-opacity-30 transition-colors">
                        <i class="fas fa-edit mr-2"></i> Edit Profile
                    </button>
                    <button class="px-5 py-2.5 bg-white text-[#b0b0cf] font-semibold rounded-lg hover:bg-gray-100 transition-colors">
        ...
        <div class="grid grid-cols-12 gap-8">
            ...
            <aside class="col-span-12 lg:col-span-3">
                <div class="bg-white rounded-2xl p-4 shadow-sm">
                    <nav class="space-y-2">
                        <a href="#" class="flex items-center gap-4 px-4 py-3 text-white bg-[#b0b0cf] rounded-lg">
                            <i class="fas fa-tachometer-alt w-5 text-center"></i>
                            <span class="font-semibold">Dashboard</span>
                        </a>
                        <a href="#" class="flex items-center gap-4 px-4 py-3 text-[#202025] rounded-lg hover:bg-[#b0b0cf] hover:text-white transition-colors group">
            ...
            <main class="col-span-12 lg:col-span-9">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm mb-8">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="#" class="text-[#b0b0cf] font-semibold">View All</a>
                    </div>
                    <div class="grid md:grid-cols-2 gap-6">
                        <!-- Course Item -->
                        <div class="flex items-center gap-5 p-4 rounded-xl border border-gray-100">
                            <img src="https://via.placeholder.com/100" alt="Course thumbnail" class="w-20 h-20 rounded-lg object-cover">
                            <div class="flex-grow">
                                <h3 class="font-bold">Advanced Mathematics</h3>
                                <p class="text-sm text-gray-500 mb-2">Dr. Evelyn Reed</p>
                                <div class="w-full bg-gray-200 rounded-full h-2.5">
                                    <div class="bg-[#b0b0cf] h-2.5 rounded-full" style="width: 75%"></div>
                                </div>
                            </div>
                        </div>
                        <!-- Course Item -->
                        <div class="flex items-center gap-5 p-4 rounded-xl border border-gray-100">
                            <img src="https://via.placeholder.com/100" alt="Course thumbnail" class="w-20 h-20 rounded-lg object-cover">
                            <div class="flex-grow">
                                <h3 class="font-bold">Modern Physics</h3>
                                <p class="text-sm text-gray-500 mb-2">Dr. Alan Grant</p>
                                <div class="w-full bg-gray-200 rounded-full h-2.5">
                                    <div class="bg-[#b0b0cf] h-2.5 rounded-full" style="width: 45%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm">
                    <div class="text-center py-10">
                        ...
                        <button class="px-6 py-3 bg-[#b0b0cf] text-white font-semibold rounded-lg hover:bg-[#8a8aac] transition-colors">
                            Explore Courses
                        </button>
                    </div>
                </div>
