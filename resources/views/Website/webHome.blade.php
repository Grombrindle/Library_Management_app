        ...
        <section class="relative bg-gradient-to-br from-[#b0b0cf] to-[#d8d8e7] text-white py-24 overflow-hidden">
            <div class="container mx-auto px-6 relative z-10">
                <div class="max-w-3xl text-center md:text-left">
                    ...
                    <a href="/webcourses" class="bg-[#202025] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#3a3a40] transition-colors shadow-lg">
                        Explore Courses
                    </a>
                </div>
            </div>
        ...
        <section class="py-20 bg-white">
            <div class="container mx-auto px-6">
                <div class="grid md:grid-cols-3 gap-8 text-center">
                    ...
                    />
                    <x-web-stat-card
                        number={{ App\Models\Teacher::count() }}
