<x-web-layout>
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @forelse(App\Models\User::findOrFail(session('user'))->courses as $course)
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                <div class="relative">
                    ...
                    <div class="absolute top-4 right-4 px-3 py-1 bg-[#b0b0cf] text-white text-sm font-bold rounded-full">
                        {{ rand(0,1) ? 'Completed' : 'In Progress' }}
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        @php
                            $completedLectures = App\Models\User::findOrFail(session('user'))->lectures()->where('course_id', $course->id)->count();
        ...
        <div class="mt-8">
            {{ App\Models\Course::paginate(12)->links() }}
        </div>
