                ...
                <div>
                    ...
                    <div class="custom-file-input">
                        ...
                        <label for="actual-file-input-360"
                            ...
                            <span class="file-input-text" id="file-input-text-360">{{ __('messages.chooseFile') }} @if ($lecture->file_360 != null)
                ...
                <div>
                    ...
                    <div class="custom-file-input">
                        ...
                        <label for="actual-file-input-720" class="file-input-label"
                            ...
                            <span class="file-input-text" id="file-input-text-720">{{ __('messages.chooseFile') }} @if ($lecture->file_720 != null)
                                    <br> ({{ __('messages.fileAlreadyUploaded') }})
                                @endif
                            </span>
                        </label>
                ...
                <div style="margin-left:auto;margin-right:auto;">
                    ...
                    <div class="custom-file-input">
                        ...
                        <label for="actual-file-input-1080" class="file-input-label"
                            ...
                            <span class="file-input-text" id="file-input-text-1080">{{ __('messages.chooseFile') }} @if ($lecture->file_1080 != null)
                                    <br> ({{ __('messages.fileAlreadyUploaded') }})
                                @endif
                            </span>
                        </label>
