...
<div style="max-width:400px;margin:40px auto;padding:30px;border-radius:10px;background:#fff;box-shadow:0 2px 8px #ccc;">
    ...
    <form method="POST" action="{{ route('web.login') }}">
        ...
        <button type="submit" style="width:100%;padding:10px;background:#333;color:#fff;border:none;border-radius:5px;">Login</button>
    </form>
    <div style="margin-top:15px;text-align:center;">
        <a href="{{ route('web.register') }}">Don't have an account? Register</a>
    </div>
</div>
@endsection 